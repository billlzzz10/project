...
class N8NService:
    ...
    def get_notion_pages(self, database_id=None):
        ...
        return self.trigger_workflow(
            "get_notion_stats", {"database_id": database_id, "action": "count_pages"}
        )
    ...
    def get_airtable_records(self, base_id=None, table_name=None):
        ...
        return self.trigger_workflow(
            "get_airtable_stats",
            {"base_id": base_id, "table_name": table_name, "action": "count_records"},
        )
    ...
    def schedule_daily_report(self):
        ...
        return self.trigger_workflow(
            ...
            {"schedule_time": "14:00", "timezone": "Asia/Bangkok"},
        )
