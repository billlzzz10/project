...
class VisualizationService:
    ...
    def create_board(
        self, user_id, title, description=None, elements=None, template=None
    ):
        """Create a new board"""
        try:
    ...
    def create_graph(
        self, user_id, title, description=None, nodes=None, edges=None, layout=None
    ):
    ...
    def generate_mind_map_from_text(self, user_id, title, content, description=None):
        ...
        try:
            ...
            return self.create_board(
                user_id, title, description, elements, template="mind_map"
            )
        ...
        if template == "mind_map":
            ...
            for i, (node_type, label) in enumerate(zip(node_types, node_labels)):
                ...
                if node_type == "start" or node_type == "end":
                    style.update({"backgroundColor": "#4CAF50", "borderRadius": "30px"})
                elif node_type == "process":
                    style.update({"backgroundColor": "#2196F3", "borderRadius": "5px"})
