...
def create_board():
    ...
    try:
        ...
        result = current_app.visualization_service.create_board(
            user_id, title, description, elements, template
        )
...
def update_board(board_id):
    ...
    try:
        ...
        result = current_app.visualization_service.update_board(
            board_id, title, description, elements
        )
        return jsonify(result), 200
...
def create_graph():
    ...
    try:
        ...
        result = current_app.visualization_service.create_graph(
            user_id, title, description, nodes, edges, layout
        )
        return jsonify(result), 200
...
def generate_mind_map():
    ...
    try:
        ...
        result = current_app.visualization_service.generate_mind_map_from_text(
...
def generate_graph_from_work():
    ...
    try:
        ...
        result = current_app.visualization_service.generate_graph_from_work_items(
